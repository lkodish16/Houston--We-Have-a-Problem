...
Instead of opening the textbook when the engine is unchecked:
		say "You don't have a maintenance problem that needs solving, so there's no reason to look up anything in the textbook.".
		
		
Instead of opening the textbook when the engine is checked:
...
The Maintenance Room is a room. It is west of the Crew's Quarters. "The room that holds the engine of the space ship. The lights are flashing red, giving the impression that something might have gone wrong. The Crew's Quarters are to the East. The Mess Hall is to the North, and the Observation Deck is to the West." 
...
The Engine is scenery in the Maintenance Room. The engine can be unchecked or checked. The engine is unchecked. The description is "A standard UNSA spaceship engine. It takes up most of the room due to its size. There is a large 'United Nations Space Association' sticker placed in the middle of the engine. Upon further examining the engine, you can see that the nitrogen compressor is broken.". 

After examining the engine:
	say "A standard UNSA spaceship engine. It takes up most of the room due to its size. There is a large 'United Nations Space Association' sticker placed in the middle of the engine. Upon further examining the engine, you can see that the nitrogen compressor is broken.";
	now the engine is checked. 


The Mess Hall is a room. It is north of the Maintenance Room. "This is the room where the astronauts eat their meals. There are long table for eating, similar to what you would see in a school cafeteria. It's around breakfast time, so this room should be bustling with hungry crew members, but they've all left the ship. You thought you were the only person left on the ship, but you see a very hungry looking astronaut sitting down at one of the tables. The Kitchen is to the North" 
...
The Kitchen is a room. It is north of the kitchen door. "The room where the head chef aboard the ship would prepare all of the meals for the crew members. It appears that most of the food and supplies have been taken by the crew members who left on the escape pods. You can see the refrigerator where the chef would keep all of his ingredients. The Mess Hall is to the South." 
...
The Observation Deck is a room. It is west of the Maintenance room. "This is a room in the ship where people go to relax. It has some comfortable sofas for people to sit on, and they face a large plate of glass that acts as a window. If you look through the window, you can see the wing of the spaceship, as well as the infinite cosmos you have been traveled through for the last two years. The Medical Bay is to the West. The Command Room is to the South, and the Maintenance Room is to the East."
...
The Medical Bay is a room. It is west of the Observation Deck. "A room that is used to treat any injuries that the astronauts may have on the ship. You see a storage locker used to hold chemicals and medical equipment. Most of the equipment in the room appears to have been taken by the evacuated crew members, but there still might be something in the storage locker. The Observation Deck is ot the East." 
...
After examining the television moniters:
