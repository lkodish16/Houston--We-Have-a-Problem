...
Crew's Quarters is a room. "This is the room you have shared with your fellow astronauts for the last two years. The room is large enough to fit the twenty or so beds needed to accommodate all of the astronauts on the ship. You don't have a bedside desk or anything like that, so you've had to keep your things under your bed. [line break]The Maintenance Room is to your west." 
...
The bed is scenery in the Crew's Quarters. "A folding bed with an old mattress on it. It's similar to a standard military bed, with a metal headboard and bedframe."   
...
Instead of looking under the bed for more than the first time:
	if the player is carrying the Auto-Mechanic:
		say "The Auto-Mechanic was all you kept down here. There's nothing else.";
	if the Auto-Mechanic is in the crew's quarters:
		say "You find the Auto-Mechanic you keep under your bed.".
		
The Auto-Mechanic is a thing. It is a device. The description is "A device that when switched on, can be used to diagnose any problem that may occur with any type of engine, provided you are in the presence of an engine.".
...
Instead of switching on Auto-Mechanic:
	if the player is in the maintenance room:
		say "The auto-mechanic shows that there is engine is suffering from a broken nitrogen compressor. It says it can be fixed with a wrench, and an antenna.";
	otherwise if the player is not in the maintenance room: 
		say "The auto-mechanic says it cannot debug anything for you since you are not in the presence of an engine."
...
The Kitchen is a room. It is north of the kitchen door. "The room where the head chef aboard the ship would prepare all of the meals for the crew members. It appears that the crew members who left on the escape pods have taken most of the food and supplies. You can see the refrigerator where the chef would keep all of his ingredients. [line break]The Mess Hall is to the South." 
...
The window is scenery in the observation deck. "You look through the window, staring out at the thousands of stars your ship passes by. You can see the wing of the spaceship, and an antenna planted on the wing."
...
After opening the desk for more than the first time:
	if the player is holding the wrench:
		say "The wrench from before was all there was in the drawer."
	
The wrench is a thing. It is inside the desk. The description is "A tool normally used for twisting nuts and bolts."
...
Check reading:
	if the noun is a security handbook:
		say "You flip to a page about lockpicking, and see that a scalpel can be used to unlock a locked door if you aren't in possession of a lockpick.".
...
The Airlock is a room. It is north of the Observation Deck. "This is the Airlock. The room the astronauts on the ship must go through in order to enter space. The airlock door to the North leads to the wing of the spaceship. [line break]The Observation Deck is to the South.". 
...
Check opening the airlock door:
	if the player is not wearing the oxygen enhanced space suit:
		say "You open the airlock door and step out onto the wing and into space, but you suffocate without any oxygen to breathe.";
		end the game in death. 

The Wing is a room. It is north of the airlock door. The description is "You step through the airlock door and onto the wing of the spaceship. Even after spending two years flying through space, the wing is just as sleek and white as the day the ship blasted off from Earth. There is a small detachable antenna coming out of the wing." 
...
Instead of entering the Wing:
	if player is not holding the antenna:
		say "You step through the airlock door and onto the wing of the spaceship. Even after spending two years flying through space, the wing is just as sleek and white as the day the ship blasted off from Earth. There is a small detachable antenna coming out of the wing."

The antenna is a thing. It is in the Wing. The description is "A small metal antenna that you found on the wing of the spaceship." 

[From Kaitlyn Poentis' "Stranded" source code]
